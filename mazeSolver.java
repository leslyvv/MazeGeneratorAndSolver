...
class mazeSolver extends JPanel {
    ...
    private void playBackgroundMusic() {
        try {
            File musicFile = new File("C:\\Users\\14048\\Desktop\\Coding\\Eclipse\\delete\\src\\connection\\backgroundmusic.wav");
    ...
    public mazeSolver(int width, int height) {
        ...
        try {
            ...
            File imageFile = new File("C:\\Users\\14048\\Desktop\\Coding\\Eclipse\\delete\\src\\connection\\pacbackground.jpg");
    ...
    private void generateMaze(int x_cord, int y_cord) {
        ...
        for (DIRECTIONS dir : neighbors) {
            ...
            if (isTrue(new_xcoord, new_ycoord) && isNotVisited(new_xcoord, new_ycoord)) {
                ...
                // & direction this sets the binary bits to 1 & indicates a path
                maze[x_cord][y_cord] |= dir.cell;
                // ensures a pth leads back to current cell
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            mazeSolver maze = new mazeSolver(30, 30);
            frame.add(maze);
